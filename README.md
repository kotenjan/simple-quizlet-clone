...
image_2_question.py - creates a textfile q.txt for the quizlet.py where question is the file name and answer is the filename. The app will show the image instead.
